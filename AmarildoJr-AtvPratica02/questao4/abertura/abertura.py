...
if __name__ == "__main__":
    ...
    imagem1 = Image.open("questao4/conectados.bmp").convert("L")
    imagem2 = Image.open("questao4/abertura/conectados_abertura_3x3.jpg").convert("L")
    # imagem2 = Image.open("questao4/abertura/retangulo_buracos_erodido_3x3.jpg").convert("L")
    diferenca(imagem1, imagem2).save("questao4/abertura/conectados_diferenca.jpg")